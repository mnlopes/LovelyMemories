...
async function fixRootTranslations() {
    ...
    // Correct amenities structure with translations
    const amenities = [
        {
    ...
    // Good to Know with proper translations
    const goodToKnow = {
        "en": [
            {
                "icon": "info",
                "text": "Guest access: Access to travelers is done entirely through entry codes and is not done in a more simple way. After booking your stay, you will automatically receive all basic information. On the day of arrival, we will share the entry codes with you."
            },
            {
                "icon": "warning",
                "text": "Other things to keep in mind: We ask our guests not to use bath towels or bathrobes to clean the machine and shoes."
            },
            {
                "icon": "alert",
                "text": "Extra towels or cleaning during your stay has the value of a full cleaning fee."
            }
        ],
        "pt": [
            {
                "icon": "info",
                "text": "Acesso dos viajantes O acesso é feito inteiramente por códigos de entrada e não é feito de forma mais simples. Depois de reservar sua estadia, você receberá automaticamente todas as informações básicas. No dia da chegada, compartilharemos os códigos de entrada com você."
            },
            {
                "icon": "warning",
                "text": "Outras coisas a ter em conta Pedimos aos nossos hóspedes que não usem as toalhas de banho ou roupões de banho para limpar a maquinagem e os sapatos."
            },
            {
                "icon": "alert",
                "text": "Toalhas extras ou limpeza durante a sua estadia têm o valor de uma taxa de limpeza completa."
            }
        ]
    };

    console.log("\n📤 Updating property with corrected translations...\n");
    ...
    if (updateError) {
        ...
        console.log("\n📊 Summary:");
        console.log("- Amenities: ✅ Restored with English translations");
        console.log("- Good to Know: ✅ Translated to English");
        console.log(`\n✨ Total amenities: ${amenities.length} categories`);
        console.log(`✨ Total good to know items: ${goodToKnow.en.length} items`);
    }
}
