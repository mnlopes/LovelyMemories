...
-- list_items on the intro section holds the two highlight blocks: [{ "title": ..., "content": ... }]
...
values
    ...
    ('concierge', 'intro', 'Don''t worry, we get it done for you...', 'Personalized Service',
        ...
        '[{"title": "24/7 Support", "content": "Dedicated assistance at any time, anywhere."}, {"title": "Local Expertise", "content": "Curated experiences and hidden local access."}]'::jsonb),
    ...
    ('concierge', 'intro', 'Não se preocupe, nós tratamos de tudo...', 'Serviço Personalizado',
        ...
        '[{"title": "Suporte 24/7", "content": "Assistência dedicada a qualquer hora, em qualquer lugar."}, {"title": "Experiência Local", "content": "Experiências curadas e acesso local exclusivo."}]'::jsonb),
